...
from corroborly.engine.workspace import research_stage_template, zotero_config_for_source
...
def migrate_workspace(workspace: Path) -> list[str]:
    ...
    if "zotero" not in context:
        ...
        for key in ("strict_one_way_from_zotero_to_corroborly", "block_writes_to_zotero_directory"):
