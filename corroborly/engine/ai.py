...
from corroborly.engine.grounding import citation_instruction, validate_grounding
...
def _rank_sources_by_relevance(
    ...
    """
    from corroborly.engine.database import relevant_source_excerpts
...
def ai_review_document(
    ...
    *,
    ...
    """
    from corroborly.engine.citations import citation_plan_path
    from corroborly.engine.claims import list_claims
    from corroborly.engine.conversion import extract_text as extract_target_text
    from corroborly.engine.document_targets import resolve_document_target
    from corroborly.engine.notes import NOTE_KINDS, list_notes
