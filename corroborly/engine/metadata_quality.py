...
from corroborly.engine.filenames import author_token as _author_token
from corroborly.engine.filenames import safe_filename_token as _safe_filename_token
...
def filename_suggestion_report(workspace: Path) -> dict[str, Any]:
    ...
    report = {
        ...
        "notes": "Suggestions are deterministic only; Corroborly does not rename or move original files.",
    }
