...
from corroborly.api.routers import (
    abstracts,
    ai,
    artefacts,
    auth,
...
from corroborly.web.app import mount_web


def create_app() -> FastAPI:
    """Build the local Corroborly FastAPI app.

    A thin transport layer over `corroborly.engine` functions: routes must not
    ...
    """
    app = FastAPI(title="Corroborly Local API")
